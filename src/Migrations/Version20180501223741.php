 ...
 */
class Version20180501223741 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category ADD COLUMN image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, title, is_nsfw FROM category');
        ...
        $this->addSql('INSERT INTO category (id, title, is_nsfw) SELECT id, title, is_nsfw FROM __temp__category');
